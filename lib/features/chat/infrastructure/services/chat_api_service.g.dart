...
class _ChatApiService implements ChatApiService {
  ...
  Future<List<MessageDTO>> getMessages() async {
    ...
    try {
      _value = _result.data!
          .map(
            (dynamic i) => MessageDTO.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<LlmRequestDTO> sendMessage(LlmRequestDTO message) async {
    ...
    final _options = _setStreamType<LlmRequestDTO>(
    ...
    late LlmRequestDTO _value;
    try {
      _value = LlmRequestDTO.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
